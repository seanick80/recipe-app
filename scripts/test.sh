...
if [[ -f "Models/TestModels.swift" ]]; then
    ...
    SWIFT_SOURCES=(Models/Recipe.swift Models/GroceryItem.swift Models/ShoppingTemplate.swift Models/ListLineParser.swift Models/OCRParser.swift Models/DetectionClassifier.swift Models/BarcodeProductMapper.swift Models/PantryItemMapper.swift Models/TestHelpers.swift Models/TestShopping.swift Models/TestListParser.swift Models/TestOCR.swift Models/TestDetection.swift Models/TestBarcode.swift Models/TestPantry.swift Models/TestModels.swift)
